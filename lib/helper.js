...
const $toggleClass = function(...names){
...
const $html = function(value = null){
  ...
  this.setHTML(html);
  */ 
  if (value == null) return sanitize(this.innerHTML, { ADD_ATTR: ["target"] });
  this.innerHTML = sanitize(value);
  return this;
}
...
const $toggleAttr = function(...names){
  for (const name of names) this.toggleAttribute(name);
  return this;
};

const $removeAttr = function(...names){
